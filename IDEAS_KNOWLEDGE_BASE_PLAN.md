...
- `IdeaDomain = "philosophy" | "economics" | "markets" | "politics" | "ethics" | "other"`: one primary organising category, not an inferred ideological identity. A pattern, method, edge, or practice for buying and selling in markets is `markets`, not `economics`. Economics is how an economy works.
