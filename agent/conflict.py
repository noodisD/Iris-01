...
class ConflictSuppressionEngine:
    ...
    def suppress(self, insights: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for key, group_insights in groups.items():
    ...
    def _find_conflict(self, a: Dict, b: Dict) -> Optional[Dict]:
    ...
    def _apply_tiebreak(self, idx_a: int, idx_b: int, candidates: List[Dict], rule_reason: str) -> Tuple[Optional[int], Optional[int], str]:
        """
