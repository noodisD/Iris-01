...
class ConfidenceEngine:
    ...
    def compute_confidence(
        ...
        Args:
            ...
            directions: Optional list of labels (e.g. ['increase', 'increase', 'decrease']) 
        ...
        # 1. Data Sufficiency (Logarithmic scale normalized to 0-1)
        # We reach 1.0 at CONF_HIGH_POINTS (10)
        count = len(timestamps)
        sufficiency = min(1.0, math.log(count + 1) / math.log(CONF_HIGH_POINTS + 1))
        ...
        if count >= CONF_HIGH_POINTS and recency >= 0.5:
